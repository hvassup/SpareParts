...
from shared.util import calc_rectangle, euclidean_distance, get_lidar_points, is_point_inside_rectangle, moving_average, rand, \
...
print(world_map.map_cord_to_real(2, 2))
...
for cnt in range(1, 500):
    ...
    # print(center, width_height, _angle)
    ...
    # for i in range(1, len(path_to_explore)):
    #     visualizer.draw_line(*path_to_explore[i - 1], *path_to_explore[i], (0, 0, 0))
    ...
    left_mult, right_mult = 0.1, 0.1 #get_wheel_speeds(x, y, q, target_pos, sensors, is_bottom1_sensor_danger,
